...
/*
 * Bitmap font 8×8 — ASCII 0x20–0x7E
 * Cada caractere = 8 bytes, cada byte = 1 linha (bit 7 = coluna esquerda)
 *
 * Fonte derivada do domínio público (IBM CP437 / font8x8 project).
 * Sem dependências externas, funciona direto no framebuffer do PS3.
 */

#define FONT8X8_FIRST  0x20   /* espaço */
